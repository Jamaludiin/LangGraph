# filename: python3 single_agent_with_multiple_tools_langgraph.py
...
def agent_node(state: AgentState) -> AgentState:
    ...
    while True:
        ...
        for tool_call in response.tool_calls:
            ...
            # Add tool response into message history
        ...
        # Continue loop — LLM will now decide next step
...
# ----------------------------------------------------------
result = app.invoke(
    {"input": "What is 45 divided by 9 and what is 20 minus 5?"}
    # Try:
